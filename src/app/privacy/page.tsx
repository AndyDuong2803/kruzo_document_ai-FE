...
export default function PrivacyPolicyPage() {
  return <LegalDocument eyebrow="Legal" title="Privacy Policy" summary="This policy describes what information Kruzo Document AI handles, why it is needed, when it is shared, and the choices available to you." updatedAt="August 5, 2026" sections={sections} />;
}
